                ...
                <div class="col-md-3 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="country.php?id={$country_id}" class="btn btn-warning float-right">View cities</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                //Get the cities from database random.
                $query = query("SELECT * FROM cities ORDER BY rand()");
                confirm($query);
